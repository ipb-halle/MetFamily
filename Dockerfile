...
ENV PACK_R="cba colourpicker devtools DT FactoMineR htmltools knitr Matrix matrixStats mixOmics plotrix rCharts rmarkdown shiny shinyBS shinyjs squash stringi tools slam plotly RColorBrewer caret"
